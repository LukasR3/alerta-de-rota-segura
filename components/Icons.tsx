...
export const SignalIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 20 20" fill="currentColor">
      <path d="M2.5 12.5a.5.5 0 01.5-.5h2a.5.5 0 01.5.5v5a.5.5 0 01-.5.5h-2a.5.5 0 01-.5-.5v-5zM8.5 7.5a.5.5 0 01.5-.5h2a.5.5 0 01.5.5v10a.5.5 0 01-.5.5h-2a.5.5 0 01-.5-.5v-10zM14.5 2.5a.5.5 0 01.5-.5h2a.5.5 0 01.5.5v15a.5.5 0 01-.5.5h-2a.5.5 0 01-.5-.5v-15z" />
    </svg>
);
...
export const WifiIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M8.288 15.038a5.25 5.25 0 017.424 0M5.136 11.886c3.87-3.87 10.154-3.87 14.024 0M1.984 8.734c5.752-5.752 15.08-5.752 20.832 0" />
    </svg>
);

export const BatteryIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 20 20" fill="currentColor">
      <path fillRule="evenodd" d="M3.5 6.5A1.5 1.5 0 015 5h8.5a1.5 1.5 0 011.5 1.5v7a1.5 1.5 0 01-1.5 1.5H5a1.5 1.5 0 01-1.5-1.5v-7zM16.5 9a.5.5 0 00-.5.5v1a.5.5 0 00.5.5h.5v-2h-.5z" clipRule="evenodd" />
    </svg>
);
